...
1. MAY: Logger contracts MAY provide specialized methods for specific use cases (e.g., audit logging, performance metrics) as long as they maintain interface consistency
