...
1. MUST: All logging implementations MUST expose a public API contract with standardized method signatures (e.g., debug, info, warn, error) that can be consumed by other modules
