...
1. MUST: Integration components MUST use event-driven communication patterns when crossing architectural boundaries (process, network, or module boundaries)
