...
1. SHOULD: Recording and replay functionality SHOULD be implemented as separate, composable modules to support different use cases (debugging, demos, testing)
