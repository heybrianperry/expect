...
1. MUST: Message queue implementations MUST provide failure isolation such that external service failures do not cascade to internal application components
