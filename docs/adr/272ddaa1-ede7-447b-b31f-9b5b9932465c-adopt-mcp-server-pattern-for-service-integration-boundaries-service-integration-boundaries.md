# Adopt MCP Server Pattern for Service Integration Boundaries: Service Integration Boundaries
...
1. MUST: Service integration boundaries MUST be implemented using dedicated server classes that encapsulate protocol-specific communication logic

## Policy Block

- MUST Service integration boundaries MUST be implemented using dedicated server classes that encapsulate protocol-specific communication logic
