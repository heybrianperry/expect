...
1. MUST_NOT: Cache implementations MUST NOT cache sensitive data (authentication tokens, user credentials, private browsing data) without explicit encryption
