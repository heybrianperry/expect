# Adopt Playwright Browser Automation for E2E Testing and Demo Recording: Browser Automation Code
...
1. SHOULD: Browser automation code SHOULD be organized into reusable modules with clear separation between browser lifecycle management, locator resolution, and test/demo logic

## Policy Block

- SHOULD Browser automation code SHOULD be organized into reusable modules with clear separation between browser lifecycle management, locator resolution, and test/demo logic
