# Adopt Browser-Based Rendering with Locator Resolution for UI Automation: Locator Resolution Support
...
1. SHOULD: Locator resolution SHOULD support multiple locator strategies (CSS selectors, XPath, text content, etc.) to maximize element identification reliability

## Policy Block

- SHOULD Locator resolution SHOULD support multiple locator strategies (CSS selectors, XPath, text content, etc.) to maximize element identification reliability
