# Standardize React Hooks for UI State Management in CLI Components: Screen Components Minimize
...
1. SHOULD: Screen components SHOULD minimize direct state manipulation and delegate complex logic to custom hooks or utility functions

## Policy Block

- SHOULD Screen components SHOULD minimize direct state manipulation and delegate complex logic to custom hooks or utility functions
