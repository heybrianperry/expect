<rule_activation id="3af9183f-0fdd-47c1-b0e6-dcd2d372ff5d" title="Standardize on TypeScript Test Files with .test.ts Extension" applies_to="**/*">
...
<enforcement>
Claude Code MUST NOT skip or defer verification. All test files created or modified must conform to the .test.ts naming convention and be validated through the verification commands above.
</enforcement>