<rule_activation id="c00c8479-8de5-43de-8170-829819b59f74" title="Standardize on TypeScript Test Files with .test.ts Extension" applies_to="**/*">
...
<enforcement>
Claude Code MUST NOT skip or defer verification. All test files created must follow the .test.ts naming convention. Violations must be flagged immediately during code review or CI/CD execution.
</enforcement>