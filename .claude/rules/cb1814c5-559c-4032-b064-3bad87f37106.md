<rule_activation id="cb1814c5-559c-4032-b064-3bad87f37106" title="Standardize Structured Logging with Public API Contracts" applies_to="**/*">
...
# Verify linting enforces no direct console usage
...
<enforcement>
Claude Code MUST NOT skip or defer verification. All logging implementations and modifications must comply with these rules before commit. CI pipeline MUST fail on detection of direct console usage in production code. Code review MUST block merge requests that introduce non-compliant logging patterns.
</enforcement>
...
- Pattern detected across 3 distinct files with 90.27% significance indicates this is an established architectural pattern
- Standardized public API contracts enable consistent observability practices across the codebase
- Structured logging with consistent contracts supports modern observability tools (log aggregation, distributed tracing, alerting)
