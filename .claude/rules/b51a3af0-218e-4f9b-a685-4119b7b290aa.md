<rule_activation id="b51a3af0-218e-4f9b-a685-4119b7b290aa" title="Implement Cache Layer for Browser Runtime and Cookie Management APIs" applies_to="packages/{browser,cookies}/**/*">
...
```bash
# Check for cache implementations in key files
