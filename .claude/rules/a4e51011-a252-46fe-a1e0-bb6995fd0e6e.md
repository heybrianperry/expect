<rule_activation id="a4e51011-a252-46fe-a1e0-bb6995fd0e6e" title="Adopt Message Queue Integration Pattern for External System Communication" applies_to="**/*">
...
# Verify message queue patterns in external API integration components
...
<enforcement>
Claude Code MUST NOT skip or defer verification. All external API integrations MUST be reviewed against these rules. Violations MUST be flagged in code review and CI/CD pipelines.
</enforcement>