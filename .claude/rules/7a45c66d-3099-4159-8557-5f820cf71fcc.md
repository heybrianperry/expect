<rule_activation id="7a45c66d-3099-4159-8557-5f820cf71fcc" title="Standardize Cache Layer Implementation for Module Resolution and State Management" applies_to="**/*">
These rules are ALWAYS ACTIVE for all files. Cache layer implementations must use consistent interfaces and patterns across libraries and modules to ensure predictable behavior, maintainability, and optimal resource utilization.
</rule_activation>
...
<enforcement>
Claude Code MUST NOT skip or defer verification. All cache layer implementations must be verified against these rules during code review and CI builds. Violations require documented exceptions with performance justification.
</enforcement>