<rule_activation id="a9e29ea3-d780-4b9c-aa00-7480073c8a6b" title="Standardize Environment Variable Validation and Path Resolution for Runtime Configuration" applies_to="**/*">
...
- First verification command returns 0 (no unvalidated environment variable access)
- Second verification command returns 0 (no unnormalized path construction)
...
<enforcement>
Verification is MANDATORY. Claude Code MUST NOT skip or defer verification when modifying configuration code, environment variable access, or path resolution logic. All changes to files in scope MUST be verified against these rules before completion.
</enforcement>