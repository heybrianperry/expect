...
## ADR 1: Adopt MCP Server Pattern for Service Integration Boundaries: Service Integration Boundaries

1. Service integration boundaries MUST be implemented using dedicated server classes that encapsulate protocol-specific communication logic

---

## ADR 2: Adopt MCP Server Pattern for Service Integration Boundaries: Implementations Extend Base

1. Implementations MAY extend base server patterns with domain-specific functionality while maintaining protocol compliance